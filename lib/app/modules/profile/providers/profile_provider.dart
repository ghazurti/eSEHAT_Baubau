...
class ProfileProvider extends GetConnect {
  ...
  Future<List<StatistikPasienModel>> fetchStatisticsPasien(dynamic body) async {
    final response = await post('apm/jumlahkunjungan', body);
    return statistikPasienModelFromJson(response.bodyString!);
  }
}
